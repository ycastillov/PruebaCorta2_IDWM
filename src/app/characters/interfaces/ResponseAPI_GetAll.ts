// To parse this data:
//
//   import { Convert, ResponseAPIGetAll } from "./file";
//
//   const responseAPIGetAll = Convert.toResponseAPIGetAll(json);
//
...
export class Convert {
    public static toResponseAPIGetAll(json: string): ResponseAPIGetAll {
        return cast(JSON.parse(json), r("ResponseAPIGetAll"));
    }

    public static responseAPIGetAllToJson(value: ResponseAPIGetAll): string {
        return JSON.stringify(uncast(value, r("ResponseAPIGetAll")), null, 2);
    }
}
